...
return [
    ...
    'products' => [
        ...
        'total-reviews' => ':total Comentarios',
        'total-rating' => ':total_rating Calificaciones & :total_reviews Calificaciones',
        'by' => 'Por :name',
    ...
    'mail' => [
        ...
        'invoice' => [
            'heading' => 'Tu factura #:invoice_id for Orden #:order_id',
        ...
        'customer' => [
            ...
            'registration' => [
                ...
                'summary' => 'Su cuenta se ha creado correctamente y puede iniciar sesión con su dirección de correo electrónico y credenciales de contraseña. Al iniciar sesión, podrá acceder a otros servicios, como revisar pedidos anteriores, listas de deseos y editar la información de su cuenta.',
                'thanks' => '¡Gracias!',
            ],
